                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Field_Widget(
                      ...
                      control: _pinCode,
                        validate:  (value) {
                          RegExp regex = new RegExp('([1-9]{1}[0-9]{5}|[1-9]{1}[0-9]{3}\\s[0-9]{3})');
                    ...
                    Button_Widget(
                      pressed: () {
                        ...
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Profile_Pic(name: _name.text, address: _address.text, email: _email.text, mobNo: _mobNo.text, pinCode: _pinCode.text,)));
                      },
                      text: "Next",
                      width: 225,
                    )
