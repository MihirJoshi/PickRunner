...
class Adhar_Details extends StatefulWidget {
  ...
  File profilePath;
  Adhar_Details({Key? key, required this.profilePath, required this.name, required this.email, required this.address, required this.mobNo, required this.pinCode}) : super(key: key);
                        ...
                        pressed: () {
                          if (_adharFront != null && _adharBack != null) {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => PAN_Details(name: widget.name, address: widget.address, email: widget.email, mobNo: widget.mobNo, pinCode: widget.pinCode, profilePath: widget.profilePath, adharNo: adharNo.text, adharFrontPath: _adharFront!, adharBackPath: _adharBack!,)));
                          } else {
