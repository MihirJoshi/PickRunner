// ignore_for_file: must_be_immutable, prefer_final_fields, non_constant_identifier_names
...
class PAN_Details extends StatefulWidget {
  ...
  PAN_Details(
      ...
      required this.adharBackPath,
      required this.adharFrontPath})
      : super(key: key);
                        ...
                        pressed: () {
                          if (_panCard != null) {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => Driving_Details(
                                          name: widget.name,
                                          email: widget.email,
                                          ...
                                          pathAdharFront: widget.adharFrontPath,
                                          pathAdharBack: widget.adharBackPath,
                                          panNo: _panNo.text,
                                          pathPAN: _panCard!,
                                        )));
                          } else {
