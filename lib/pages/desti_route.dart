...
import 'package:pickrunner/pages/order_code.dart';
...
class DestinationRoute extends StatefulWidget {
  ...
  DestinationRoute({Key? key, required this.d_lat, required this.d_lng, required this.driverUid, required this.p_lat, required this.p_lng}) : super(key: key);

  @override
  State<DestinationRoute> createState() => _DestinationRouteState();
}
...
class _DestinationRouteState extends State<DestinationRoute> {
  ...
  double distance = 0.0;
    late double? pLat = widget.p_lat;
    late double? pLng = widget.p_lng;
    late double? dLat = widget.d_lat;
    late double? dLng = widget.d_lng;
  ...
  Widget build(BuildContext context) {
            ...
            Row(
              children: [
                ...
                Expanded(
                  child: Column(
                    children: [
                      OrderDisplayWidget(line: "Address: ", data: _activeOrder?.destiAddress?? ""),
                      const SizedBox(
                        height: 12,
                      ),
                      const Divider(
                      ...
                      Row(
                        children: [
                          ...
                          SizedBox(width: 12,),
                          BigText(title: _activeOrder?.destiTime??"", size: 18, weight: FontWeight.normal,),
                        ],
                      ),
                      const SizedBox(
                        height: 8,
                     ...
                     Row(
                        children: [
                          ...
                          SizedBox(width: 12,),
                          BigText(title: _activeOrder?.destiMobno??"", size: 18, weight: FontWeight.normal,),
                        ],
                      ),
                      const SizedBox(
                        height: 8,
                      ...
                      Row(
                        children: [
                          ...
                          SizedBox(width: 12,),
                          BigText(title: _activeOrder?.destiName??"", size: 18, weight: FontWeight.normal,),
                        ],
                      ),
                      const SizedBox(
                        height: 8,
                      ...
                      Row(
                        children: [
                          ...
                          SizedBox(width: 12,),
                          BigText(title: _activeOrder?.destiInstruct??"", size: 18, weight: FontWeight.normal,),
                        ],
                      ),
                      const SizedBox(
                        height: 8,
   ...
   Widget bottomSheet() {
    return FractionallySizedBox(
      heightFactor: 0.55,
      child: OrderCode(order: _activeOrder!,),
    );
  }
}