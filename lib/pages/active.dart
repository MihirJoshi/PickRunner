            ...
            : Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      "Weight: ${_activeOrder!.weight.toString()} KG"
                      " "
                      " "
                      " "
                      "Type: ${_activeOrder!.category}",
                      style: TextStyle(
                          fontSize: 16,
                        ...
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) => Direction(
                                      ...
                                      c_lat: _currentPosition!.latitude,
                                      c_lng: _currentPosition!.longitude,
                                      p_lat: _activeOrder!.picLat!,
                                      p_lng: _activeOrder!.picLng!,
                                    )));
                      },
                      width: 270,
                      text: "Direction"),
